...
interface AuthDeniedPageProps {
  onNavigate: (path: string) => void;
}

export const AuthDeniedPage: React.FC<AuthDeniedPageProps> = ({ onNavigate }) => {
        ...
        <div className="p-8 sm:p-10 rounded-3xl bg-[#111416]/95 border border-[#8C0B12]/40 shadow-[0_0_60px_rgba(140,11,18,0.25)] space-y-6 text-center">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-[#A8A1A1] max-w-md mx-auto leading-relaxed">
              The administrator has reviewed and declined this access clearance request for the private vault resources. If you believe this is an error or require specific partnership materials, please reach out directly.
            </p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-[#080808] border border-white/10 text-left space-y-2 text-xs font-mono">
            ...
            <div className="flex justify-between text-[#A8A1A1]">
              ...
              <span className="text-[#E51F2A] font-bold">REJECTED BY OWNER</span>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2">
            ...
            >
              <Mail size={14} />
              <span>CONTACT AHMMAD SAKIB</span>
            </button>
